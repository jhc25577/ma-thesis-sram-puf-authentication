...
def server_program():
    ...
    if board in devices:
        ...
        if nonce_r != nonce:
            ...
            # calling mobilenet model (trained on colab) for classification
            #model = "/home/jojo755767/Documents/ma-thesis-sram-puf-authentication/authenticator/mobilenet/local-intact/model.tflite"

            # calling mobilenet model (locally trained) for classification
            model = "/home/jojo755767/Documents/ma-thesis-sram-puf-authentication/authenticator/mobilenet/local-intact/model.tflite"

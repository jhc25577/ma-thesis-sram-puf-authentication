...
def server_program():
    ...
    '-d',
    '--devices',
    default='../mobilenet/corrupted/labels.txt',
    ...
    if board in devices:
        ...
        if nonce_d != nonce:
            ...
            model = "/home/jojo755767/Documents/ma-thesis-sram-puf-authentication/authenticator/mobilenet/corrupted/model.tflite"

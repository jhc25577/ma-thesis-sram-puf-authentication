...
def server_program():
    ...
    if board in devices:
        ...
        if nonce_r != nonce:
            ...
            # model = "/home/jojo755767/Documents/ma-thesis-sram-puf-authentication/authenticator/efficientnet/noisy/model.tflite"

            # calling efficientnet_lite model (with 5 boards) for classification
            model = "/home/jojo755767/Documents/ma-thesis-sram-puf-authentication/authenticator/efficientnet/noisy/5-boards/model.tflite"
